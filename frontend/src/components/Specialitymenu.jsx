    ...
    <section className="py-20 bg-gray-50" id="speciality">
      ...
      <div className="max-w-6xl mx-auto text-center px-4">
        ...
        <p className="text-gray-600 text-lg sm:text-xl max-w-3xl mx-auto">
          Browse our range of professional career coaching services. Whether you
          want to build a standout CV, optimize your LinkedIn profile, or get
          personalized coaching, we have the right solutions to guide you toward
          your dream career.
        </p>
      </div>
